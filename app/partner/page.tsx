    ...
    <>
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-[700px] px-5 md:px-16">
          <h1 className="font-display text-4xl md:text-hero font-bold text-white leading-[1.1] mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="inline-block bg-[#fee198] text-[#1a1a1a] font-semibold text-base px-10 py-4 hover:bg-[#c1121f] hover:text-white transition-all text-center"
            >
              Get Featured
            </Link>
            <a
              href="https://atlvibesandviews.hflip.co/36036a0e90.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block border-2 border-white text-white font-semibold text-base px-10 py-4 hover:bg-white hover:text-black transition-all text-center"
            >
              View Media Kit
            </a>
          </div>
      ...
      <section className="py-16 bg-white text-center">
        <div className="site-container">
          ...
          <RotatingScope />
          <p className="text-lg md:text-xl text-[#555] leading-relaxed max-w-[750px] mx-auto">
            ATL Vibes &amp; Views spotlights the people, places, and ideas shaping Atlanta through independent editorial storytelling rooted in trust, culture, and community.
          </p>
        </div>
      </section>
          ...
          {COVERAGE.map((card) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <span className="text-[#fee198] text-sm font-semibold uppercase tracking-wider hover:text-white transition-colors">
                  Explore {card.title.split(" ")[0]} &rarr;
                </span>
              </div>
            </Link>
          ))}
      ...
      <section className="py-20 md:py-24 bg-[#f8f8f8]">
        <div className="flex flex-col lg:flex-row items-center max-w-[1200px] mx-auto px-5 md:px-10">
          <div className="relative w-full lg:w-[550px] h-[280px] lg:h-[550px] shrink-0">
            <Image
          ...
          <div className="bg-white p-8 md:p-12 lg:-ml-28 relative z-10 shadow-[0_15px_60px_rgba(0,0,0,0.12)] flex-1 max-w-[650px] -mt-12 lg:mt-0 mx-5 lg:mx-0">
            <p className="text-[13px] font-semibold text-[#c1121f] uppercase tracking-[0.15em] mb-4">
              Big ideas. Bold stories. Atlanta roots.
            </p>
            <h2 className="font-display text-3xl md:text-[44px] font-semibold text-black leading-[1.1] mb-6">
              Your Vibe Is Our View.
            </h2>
      ...
      <section className="py-20 md:py-24 bg-white text-center">
        <div className="site-container max-w-[850px]">
          ...
          <Link
            ...
            className="inline-block bg-[#fee198] text-[#1a1a1a] font-semibold text-base px-10 py-4 hover:bg-[#c1121f] hover:text-white transition-all"
          >
      ...
      <section className="relative py-24 md:py-32 text-center overflow-hidden">
        ...
        <div className="relative z-10 site-container">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/partner/contact"
              className="inline-block bg-[#fee198] text-[#1a1a1a] font-semibold text-base px-10 py-4 hover:bg-white transition-all text-center"
            >
